...
5. 매니저
    - [ ] 기능 테스트: 주문 목록에서 증정 상품 및 정가 상품 목록 생성 크기 확인
...
5. 매니저
    - [ ] 증정 상품 및 실제 정가 상품 개수 계산하기
    - [ ] 실제 주문량을 반영해 재고 수량을 관리하기
    - [ ] 사용자로부터 행사 상품 추가 및 정가 계산 여부 확인하기
